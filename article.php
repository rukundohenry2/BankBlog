...
<div class="restbody">
    ...
    <?php
                $sql = "SELECT * FROM article where idArticle= ".$articleid."";
                $result = $conn->query($sql);


                if ($result->num_rows > 0) {
                    // output data of each row
                    $rowarticle = $result->fetch_assoc();
    ...
    <div class="aboutsection">
        <?php
            echo "<img src='".$pararow["imgloc"]."' alt='bloggerimage'>";
            echo "<div class='personal'>";
                echo "<p class='bloggerName'>".$pararow["firstname"]." ".$pararow["lastname"]."</p>";
            echo "</div>";
        ?>
