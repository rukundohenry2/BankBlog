<?php
    ...
    function emptyInputSignup($firstname,$middlename,$lastname, $email, $phonenumber, $password_1, $password_2){
        $result;
        if(empty($firstname)||empty($middlename)||empty($lastname)||empty($email)||empty($phonenumber)||empty($password_1)||empty($password_2)){
            $result=true;
        }  
        else{
            $result = false;
