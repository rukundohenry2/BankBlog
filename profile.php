    ...
    <div class="restbody">
        ...
        <div class="profile">
            ...
            <div class="profilemenu">
                ...
                <a class="menuitem" href="newarticle.php">
            ...
            <div class="articles">
                <?php
                    ...
                    $sql = "SELECT * FROM article WHERE Bloggers_bloggerId = $userid Order by idArticle DESC";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($rowarticle = $result->fetch_assoc()) {
                            ...
                            $anoSql = "SELECT * FROM `articleparagraph` WHERE Article_idArticle = $articleid";
                            $anoresult = $conn->query($anoSql);
                            
                            echo "<div class='article'>";
                                
                                echo "<div class='edittab'>";
                                    echo "<p class= 'articlehead'>".$articletitle."</p>";
                                    echo "<a href=''>Edit <img src='media/icons/icons8_edit_104px_1.png' alt=''></a>";
                                echo "</div>";
                                ...
                                $anoSql = "SELECT * FROM `bloggers` WHERE bloggerId = $blogerid" ;
                                $anoresult = $conn->query($anoSql);
